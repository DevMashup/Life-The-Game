...
MASH_b spbSavingsE::RegSavingsSPB::hasAccount = false;
MASH_f spbSavingsE::RegSavingsSPB::Amount = 0.00;
MASH_int64t spbSavingsE::RegSavingsSPB::accNum = 0;
MASH_b spbSavingsE::RegSavingsSPB::hasCard = false;

void spbSavingsE::RegSavingsSPB::Create()
{
	Universal u;
	...
	if (!hasAccount) {
		if (AppD::Age < 9) {
			...
			spbSavingsD::RegSavingsSPB SavingsD;
			spbSavingsTF::RegSavingsSPB SavingsTF;

			accNum = accNumrnd;

			spbSavingsD::RegSavingsSPB::Amount = Amount;
			spbSavingsD::RegSavingsSPB::accNum = accNum;

			spbSavingsTF::RegSavingsSPB::accNum = accNum;
			...
			if (Parent == "Father" || Parent == "father") {
				if (fatherHelp == 1) {
					...
					if (getCard != 5) {
						...
						hasCard = true;
						spbSavingsTF::RegSavingsSPB::Amount = Amount;
...
void spbSavingsE::RegSavingsSPB::Withdrawal(MASH_f num)
{
	Amount -= num;
...
void spbSavingsE::RegSavingsSPB::Deposit(MASH_f num)
{
	Amount += num;
...
MASH_f spbSavingsE::RegSavingsSPB::GetBankAmount()
{
	return Amount;
}
