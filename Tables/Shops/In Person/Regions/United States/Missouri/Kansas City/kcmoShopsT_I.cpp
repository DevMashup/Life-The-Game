#include "kcmoShopsT_I.h"

void kcmoShopsT_I::CreateTable()
{
	Universal u;
...
void kcmoShopsT_I::AddItems(MASH_vec<MASH_str>& items)
{
	items.push_back("NULL     ");
	items.push_back("PH Airport");
	items.push_back("Ashley's Furry Friends");
