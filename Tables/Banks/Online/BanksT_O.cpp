...
void BanksT_O::AddItems(MASH_vec<MASH_str>& items)
{
	items.push_back("NULL            ");
	items.push_back("Mashup Inc      ");
	items.push_back("Sally's Finances");
