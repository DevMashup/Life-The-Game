#include "phCheckingsTF.h"

MASH_int64t phCheckingsTF::RegCheckingsPH::accNum = 0;
MASH_f phCheckingsTF::RegCheckingsPH::Amount = 0.00;

void phCheckingsTF::RegCheckingsPH::Log()
{
	Universal u;
