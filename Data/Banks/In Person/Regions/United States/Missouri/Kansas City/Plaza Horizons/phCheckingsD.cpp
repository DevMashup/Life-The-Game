#include "phCheckingsD.h"

MASH_str phCheckingsD::RegCheckingsPH::Folder = " ";
MASH_str phCheckingsD::RegCheckingsPH::File = " ";
MASH_json phCheckingsD::RegCheckingsPH::Data;
MASH_b phCheckingsD::RegCheckingsPH::isData = false;

MASH_f phCheckingsD::RegCheckingsPH::Amount = 0.00;
MASH_int64t phCheckingsD::RegCheckingsPH::accNum = 0;

void phCheckingsD::RegCheckingsPH::CreateData()
{
	CreateFolder();
	CreateFile();
}

void phCheckingsD::RegCheckingsPH::CreateFolder()
{
	Universal u;
...
void phCheckingsD::RegCheckingsPH::CreateFile()
{
...
void phCheckingsD::RegCheckingsPH::UpdateCityFile()
{
}

void phCheckingsD::RegCheckingsPH::UpdateBanksFile()
{
